...
<th class="table-primary"><center>Jenis Kelamin</center></th>
<th class="table-primary"><center>Tanggal Lahir</center></th>
<th class="table-primary"><center>Status</center></th>
<th class="table-primary"><center>Pekerjaan</center></th>
...
$page = (isset($_GET['page']))? (int) $_GET['page'] : 1;
    ...
    $SqlQuery = mysqli_query($koneksi, "SELECT * FROM pegawai LIMIT ".$limitStart.",".$limit);
